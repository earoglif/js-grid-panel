...
var _GridPanel = __webpack_require__(126);
...
var gridPanel = new _GridPanel2.default({
    ...
    columns: [{
        ...
        render: function render(value, props, extra) {
            var mode = extra.itemsQuickLookItemMenuChangeModuleMode;
...
var GridPanel = function () {
    ...
    _createClass(GridPanel, [{
        ...
        key: 'setExtraData',
        value: function setExtraData(extraData) {
        ...
        value: function addRows(newRows) {
            ...
            newRows.forEach(function (itemRow, i) {
        ...
        value: function renderRow(itemCol, itemRow, gridColumn, gridRow) {
            ...
            var value = itemCol.render && this.isFunction(itemCol.render) ? itemCol.render(itemRow[itemCol.dataIndex], itemRow, this.extraData) : itemRow[itemCol.dataIndex];
...
var _GridPanel = __webpack_require__(125);

var _GridPanel2 = _interopRequireDefault(_GridPanel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _GridPanel2.default;
...
var $export = __webpack_require__(0);
var invoke = __webpack_require__(53);
var partial = __webpack_require__(133);
